...
SOUNDS_STREAMING_PARAMS = dict({
    ...
    'zone1_2_shopkeeper':     WaltzParams.WaltzParams("../../data/sounds_streaming/zone1_2_shopkeeper.ogg",     130, True,  True,  20, "./sounds_streaming/zone1_2_shopkeeper.ogg"    ),
    'zone1_2_shopkeeper_m':   WaltzParams.WaltzParams("../../data/sounds_streaming/zone1_2_shopkeeper_m.ogg",   130, True,  True,  20, "./sounds_streaming/zone1_2_shopkeeper_m.ogg"  ),
    'zone1_2_shopkeeper_nd':  WaltzParams.WaltzParams("../../data/sounds_streaming/zone1_2_shopkeeper_nd.ogg",  130, True,  True,  20, "./sounds_streaming/zone1_2_shopkeeper_nd.ogg" ),
    ...
    'zone2_1_shopkeeper':     WaltzParams.WaltzParams("../../data/sounds_streaming/zone2_1_shopkeeper.ogg",     130, True,  True,  20, "./sounds_streaming/zone2_1_shopkeeper.ogg"    ),
    'zone2_1_shopkeeper_m':   WaltzParams.WaltzParams("../../data/sounds_streaming/zone2_1_shopkeeper_m.ogg",   130, True,  True,  20, "./sounds_streaming/zone2_1_shopkeeper_m.ogg"  ),
    'zone2_1_shopkeeper_nd':  WaltzParams.WaltzParams("../../data/sounds_streaming/zone2_1_shopkeeper_nd.ogg",  130, True,  True,  20, "./sounds_streaming/zone2_1_shopkeeper_nd.ogg" ),
    ...
    'zone5_3_shopkeeper':     WaltzParams.WaltzParams("../../data/sounds_streaming/zone5_3_shopkeeper.ogg",     155, False, False, 10, "./sounds_streaming/zone5_3_shopkeeper.ogg",    timeSwitchBeats=[112, 152, 336]),
    'zone5_3_shopkeeper_m':   WaltzParams.WaltzParams("../../data/sounds_streaming/zone5_3_shopkeeper_m.ogg",   155, False, False, 10, "./sounds_streaming/zone5_3_shopkeeper_m.ogg",  timeSwitchBeats=[112, 152, 336]),
    'zone5_3_shopkeeper_nd':  WaltzParams.WaltzParams("../../data/sounds_streaming/zone5_3_shopkeeper_nd.ogg",  155, False, False, 10, "./sounds_streaming/zone5_3_shopkeeper_nd.ogg", timeSwitchBeats=[112, 152, 336])
})
