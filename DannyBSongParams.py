...
DANNYB_SONG_PARAMS = dict({
    ...
    'boss_4':    WaltzParams.WaltzParams("../../data/music/boss_4.ogg",    126, False, True,  10,    "./music/boss_4.ogg"   ),
    ...
    'zone2_1':   WaltzParams.WaltzParams("../../data/music/zone2_1.ogg",   130, True,  False, 10,    "./music/zone2_1.ogg"  ),
    ...
    'zone3_3c':  WaltzParams.WaltzParams("../../data/music/zone3_3c.ogg",  155, False, True,  10,    "./music/zone3_3c.ogg" ),
