...
JULES_SONG_PARAMS = dict({
    ...
    'boss_2':   WaltzParams.WaltzParams("./sync_fix/music/boss_2_2.ogg",   175, False, False, 10, "./music/boss_2_2.ogg"  ),
    ...
    'boss_7':   WaltzParams.WaltzParams("../../data/music/boss_7_2.ogg",   0,   False, False, 10, "./music/boss_7_2.ogg",  [], "../../data/music/boss_7.txt"),
    'boss_8':   WaltzParams.WaltzParams("../../data/music/boss_8_2.ogg",   120, False, True,  10, "./music/boss_8_2.ogg",  [48]),
    ...
    'zone1_2':  WaltzParams.WaltzParams("../../data/music/zone1_2_2.ogg",  130, True,  False, 10, "./music/zone1_2_2.ogg" ),
    'zone1_3':  WaltzParams.WaltzParams("../../data/music/zone1_3_2.ogg",  140, False, True,  10, "./music/zone1_3_2.ogg" ),
    'zone2_1':  WaltzParams.WaltzParams("../../data/music/zone2_1_2.ogg",  130, True,  True,  10, "./music/zone2_1_2.ogg" ),
    ...
    'zone5_3':  WaltzParams.WaltzParams("./sync_fix/music/zone5_3_2.ogg",  155, False, False, 10, "./music/zone5_3_2.ogg", [112, 152, 336])
})
